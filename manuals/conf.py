...
project = "https://nixos.org/community/teams/ngi/"
...
html_theme_options = {
    "repository_url": "https://github.com/ngi-nix/ngipkgs",
...
man_pages = [
    ("Contributor", "NGIpkgs_Contributor_Manual", "NGIpkgs Contributor Manual", "NGIpkgs Contributors", 5),
    ("Options", "NGIpkgs_Options", "Module options provided by NGIpkgs", "NGIpkgs Contributors", 5),
    ("User", "NGIpkgs_User_Manual", "NGIpkgs User Manual", "NGIpkgs Contributors", 5),
]
...
texinfo_documents = [
    ("Contributor", "NGIpkgs_Contributor_Manual", "NGIpkgs Contributor Manual", "NGIpkgs Contributors", "NGIpkgs", "Manual for contributors to NGIpkgs", "Miscellaneous",),
    ("Options", "NGIpkgs_Options", "NGIpkgs' Options", "NGIpkgs Contributors", "NGIpkgs", "Module options provided by NGIpkgs", "Miscellaneous",),
    ("User", "NGIpkgs_User_Manual", "NGIpkgs User Manual", "NGIpkgs Contributors", "NGIpkgs", "Manual for users of NGIpkgs", "Miscellaneous",),
]
...
linkcheck_ignore = [
    ...
    # Explanation: to use the Web URL to the manuals within the build output
    # when referencing arbitrary files,
